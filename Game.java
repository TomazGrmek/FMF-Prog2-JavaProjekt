...
public class Game {
	...
	public static class Snake{
		...
		public Snake() {
			...
			for (int i= 0; i < 3; i++) { // na konec kace postavimo element, ki ne bo viden, in se bo uporabljal, ko dodajamo 2 elementa na rep
...
class GUI extends JFrame {
	  ...
	  public GUI(Snake snake, Food food, int score) {
	    ...
	    JMenu menu = new JMenu("Tezavnost");
	    ...
	    group.add(rbMenuItem);
	    menu.add(rbMenuItem);
	    rbMenuItem = new JRadioButtonMenuItem("Tezka");
	    rbMenuItem.addActionListener(new ActionListener() {
